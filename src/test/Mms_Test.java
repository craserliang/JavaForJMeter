...
import test.DoSendMms;


public class Mms_Test extends AbstractJavaSamplerClient {
...
//		System.out.println("host:"+host);
		...
		Mediapath=arg0.getParameter("Mediapath");
		...
		try {
            ...
            DoSendMms test = new DoSendMms(host,port,username,password,phonehead,msgCount,content,Mediapath,batchname,biztype,distinctFlag);
...
//		  params.addArgument("msgCount", "2");//设置参数
//          params.addArgument("content", "J彩信");//设置参数
//          params.addArgument("Mediapath", "F:\\javafile\\sdk5.3.0\\src\\mms_test1\\msg5");//设置参数
//          params.addArgument("batchname", "测试批次");//设置参数
//          params.addArgument("biztype", "2");//设置参数
//          params.addArgument("distinctFlag", "false");//设置参数
//          JavaSamplerContext arg0 = new JavaSamplerContext(params); 
//          Mms_Test a=new Mms_Test();
//          a.setupTest(arg0);
//          a.runTest(arg0);
//          a.teardownTest(arg0);
//      }
